...
\begin{itemize}
    \item Class Attributes:
        \begin{todolist}
            ...
            \item Attrs are private.
            \item Attrs are final.
        \end{todolist}
    \item Getters
        \begin{todolist}
    ...
    \item Overrides
        \begin{todolist}
            ...
            \item The \lstinline|compareTo| method is present and returns the comparision between the intance and a \lstinline|Vehicle| instance that is passed in as a parameter.
        \end{todolist}
\end{itemize}
